...
(async () => {
  ...
  await fs.writeFile("sinusitis-primary-care-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("sinusitis-primary-care-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
